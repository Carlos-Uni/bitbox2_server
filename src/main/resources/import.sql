...
insert into users(iduser, usercode, username, password, role) values(nextval('user_id_seq'),300, 'carlosuser', '$2a$10$MEAZXrGovHrEZXTdpHTi5u4u/ozGDb54Zi3GS2L0i.fwHhlO6dGSi', 'USER');
